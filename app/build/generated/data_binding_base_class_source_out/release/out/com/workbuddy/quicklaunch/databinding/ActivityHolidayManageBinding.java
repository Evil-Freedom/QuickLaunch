...
public final class ActivityHolidayManageBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public static ActivityHolidayManageBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityHolidayManageBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_holiday_manage, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityHolidayManageBinding bind(@NonNull View rootView) {
