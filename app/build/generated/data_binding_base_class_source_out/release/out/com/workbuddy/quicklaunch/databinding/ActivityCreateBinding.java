...
public final class ActivityCreateBinding implements ViewBinding {
  ...
  @NonNull
  public final Barrier barrierAfterBtns;

  @NonNull
  public final Barrier barrierAfterWifi;
  ...
  private ActivityCreateBinding(@NonNull ScrollView rootView, @NonNull Barrier barrierAfterBtns,
      @NonNull Barrier barrierAfterWifi, @NonNull MaterialButton btnPickApp,
    ...
    this.barrierAfterBtns = barrierAfterBtns;
    this.barrierAfterWifi = barrierAfterWifi;
  ...
  public static ActivityCreateBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.barrierAfterBtns;
      Barrier barrierAfterBtns = ViewBindings.findChildViewById(rootView, id);
      if (barrierAfterBtns == null) {
        break missingId;
      }

      id = R.id.barrierAfterWifi;
      Barrier barrierAfterWifi = ViewBindings.findChildViewById(rootView, id);
      if (barrierAfterWifi == null) {
        break missingId;
      }
      ...
      return new ActivityCreateBinding((ScrollView) rootView, barrierAfterBtns, barrierAfterWifi,
          btnPickApp, btnPickBluetooth, btnPickWifi, btnSave, btnTime, btnWinEnd, btnWinStart,
          cbRandom, cbSkipHolidays, chipRepeat0, chipRepeat1, chipRepeat2, chipRepeat3, chipRepeat4,
          chipTrigger0, chipTrigger1, chipTrigger2, chipTrigger3, layoutCustomDays, layoutOptions,
          layoutRandom, layoutTime, layoutTrigger, layoutTriggerGrid, scrollRepeat, tbDay0, tbDay1,
          tbDay2, tbDay3, tbDay4, tbDay5, tbDay6, tvRepeatTitle, tvTimeTitle, tvTriggerTitle);
    }
